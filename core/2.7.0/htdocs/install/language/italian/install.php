...
define('_WEBSITE_NAME', 'XOOPS Sito');
define('_WEBSITE_SLOGAN', 'Usalo e basta!');
define('_WEBSITE_META_KEYWORDS', 'xoops, framework di applicazioni web, cms, sistema di gestione dei contenuti');
define('_WEBSITE_FOOTER', "Realizzato da XOOPS © 2001-{X_YEAR} <a href='https://xoops.org' rel='external' title='The XOOPS Project'>Il progetto XOOPS</a>");
define('_WEBSITE_COPYRIGHT', 'Copyright © 2001-{X_YEAR}');
define('_WEBSITE_DESCRIPTION', 'XOOPS è uno script per portale open source basato su Object Oriented dinamico scritto in PHP.');
