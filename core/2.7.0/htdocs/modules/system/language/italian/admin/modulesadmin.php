...
// Navigation
// Navigation
define('_AM_SYSTEM_MODULES_ADMIN', 'Amministrazione Moduli XOOPS');
define('_AM_SYSTEM_MODULES_LIST', 'Elenco Moduli');
define('_AM_SYSTEM_MODULES_TOINSTALL', 'Installa modulo');
define('_AM_SYSTEM_MODULES_VALIDATE', 'Valida modifiche');
define('_AM_SYSTEM_MODULES_SUBMITRES', 'Risultato Invio');
// Messages
define('_AM_SYSTEM_MODULES_RUSUREINS', 'Premi il pulsante qui sotto per installare questo modulo');
define('_AM_SYSTEM_MODULES_RUSUREUNINS', 'Sei sicuro di voler disinstallare questo modulo?');
define('_AM_SYSTEM_MODULES_RUSUREUPD', 'Premi il pulsante qui sotto per aggiornare questo modulo');
define('_AM_SYSTEM_MODULES_BTOMADMIN', 'Amministrazione Moduli XOOPS');
...
define('_AM_SYSTEM_MODULES_VIEWLINE', 'Vista a Riga');
...
define('_AM_SYSTEM_MODULES_FAILWRITE', 'Impossibile scrivere nel menu principale.');
define('_AM_SYSTEM_MODULES_ALEXISTS', 'Il modulo %s esiste già.');
...
define('_AM_SYSTEM_MODULES_MENU', 'Menù');
define('_AM_SYSTEM_MODULES_HIDE', 'Nascondi');
define('_AM_SYSTEM_MODULES_SHOW', 'Mostra');
define('_AM_SYSTEM_MODULES_DUPEN', 'Voce duplicata nella tabella dei moduli!');
define('_AM_SYSTEM_MODULES_DEACTED', 'Il modulo selezionato è stato disattivato. Ora puoi disinstallare il modulo in sicurezza.');
define('_AM_SYSTEM_MODULES_ACTED', 'Il modulo selezionato è stato attivato!');
define('_AM_SYSTEM_MODULES_UPDTED', 'Il modulo selezionato è stato aggiornato!');
define('_AM_SYSTEM_MODULES_SYSNO', 'Il modulo di sistema non può essere disattivato.');
define('_AM_SYSTEM_MODULES_STRTNO', 'Questo modulo è impostato come pagina iniziale predefinita. Modifica il modulo iniziale in base alle tue preferenze.');
define('_AM_SYSTEM_MODULES_ORDER', 'Ordine');
define('_AM_SYSTEM_MODULES_ORDER0', '(0 = nascondi)');
define('_AM_SYSTEM_MODULES_ACTIVE', 'Attivo');
define('_AM_SYSTEM_MODULES_INACTIVE', 'Inattivo');
...
define('_AM_SYSTEM_MODULES_LISTUPBLKS', 'I seguenti blocchi verranno aggiornati.<br>Seleziona i blocchi i cui contenuti (template e opzioni) possono essere sovrascritti.<br>');
define('_AM_SYSTEM_MODULES_NEWBLKS', 'Nuovi Blocchi');
define('_AM_SYSTEM_MODULES_DEPREBLKS', 'Blocchi Deprecati');
// Logger
define('_AM_SYSTEM_MODULES_TABLE_RESERVED', '%s è una tabella riservata!');
define('_AM_SYSTEM_MODULES_CREATE_TABLES', 'Creazione tabelle...');
...
define('_AM_SYSTEM_MODULES_SQL_FOUND', 'File SQL trovato in %s ');
define('_AM_SYSTEM_MODULES_SQL_NOT_FOUND', 'File SQL non trovato in %s');
define('_AM_SYSTEM_MODULES_SQL_NOT_CREATE', 'ERRORE: Impossibile creare %s ');
define('_AM_SYSTEM_MODULES_SQL_NOT_VALID', '%s non è un SQL valido!');
define('_AM_SYSTEM_MODULES_GROUP_ID', ' ID Gruppo: %s ');
define('_AM_SYSTEM_MODULES_NAME', ' Nome: ');
define('_AM_SYSTEM_MODULES_VALUE', ' Valore: ');
// Templates
define('_AM_SYSTEM_MODULES_TEMPLATES_ADD', 'Aggiunta template...');
define('_AM_SYSTEM_MODULES_TEMPLATES_DELETE', 'Eliminazione template...');
define('_AM_SYSTEM_MODULES_TEMPLATES_UPDATE', 'Aggiornamento template...');
...
define('_AM_SYSTEM_MODULES_TEMPLATE_DELETE_OLD_ERROR', 'ERRORE: Impossibile eliminare il vecchio template %s. Annullamento dell\'aggiornamento di questo file. ');
...
// Blocks
define('_AM_SYSTEM_MODULES_BLOCKS_ADD', 'Aggiunta blocchi...');
define('_AM_SYSTEM_MODULES_BLOCKS_DELETE', 'Eliminazione blocco...');
define('_AM_SYSTEM_MODULES_BLOCKS_REBUILD', 'Ricostruzione blocchi...');
define('_AM_SYSTEM_MODULES_BLOCK_ID', ' ID Blocco: %s ');
define('_AM_SYSTEM_MODULES_BLOCK_ACCESS', 'Aggiunto diritto di accesso al blocco');
define('_AM_SYSTEM_MODULES_BLOCK_ACCESS_ERROR', 'ERRORE: Impossibile aggiungere il diritto di accesso al blocco');
...
define('_AM_SYSTEM_MODULES_MODULE_DATA_ADD', 'Aggiunta dati configurazione modulo...');
define('_AM_SYSTEM_MODULES_MODULE_DATA_DELETE', 'Eliminazione opzioni configurazione modulo...');
...
define('_AM_SYSTEM_MODULES_CONFIG_DATA_ADD_ERROR', 'ERRORE: Impossibile inserire la configurazione %s nel database. ');
...
// Access
define('_AM_SYSTEM_MODULES_GROUP_SETTINGS_ADD', 'Impostazione diritti di gruppo...');
define('_AM_SYSTEM_MODULES_GROUP_PERMS_DELETE_ERROR', 'ERRORE: Impossibile eliminare i permessi di gruppo ');
define('_AM_SYSTEM_MODULES_GROUP_PERMS_DELETED', 'Permessi di gruppo eliminati ');
define('_AM_SYSTEM_MODULES_ACCESS_ADMIN_ADD', 'Aggiunto diritto di accesso amministrativo per ID Gruppo %s');
define('_AM_SYSTEM_MODULES_ACCESS_ADMIN_ADD_ERROR', 'ERRORE: Impossibile aggiungere il diritto di accesso amministrativo per ID Gruppo %s');
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD', 'Aggiunto diritto di accesso utente per ID Gruppo: %s');
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD_ERROR', 'ERRORE: Impossibile aggiungere il diritto di accesso utente per ID Gruppo: %s');
// execute module specific install script if any
define('_AM_SYSTEM_MODULES_FAILED_EXECUTE', 'Esecuzione di %s fallita');
...
define('_AM_SYSTEM_MODULES_UPDATE_ERROR', 'ERRORE: Impossibile aggiornare %s');
define('_AM_SYSTEM_MODULES_DELETE_MOD_TABLES', 'Eliminazione tabelle modulo...');
define('_AM_SYSTEM_MODULES_COMMENTS_DELETE', 'Eliminazione commenti...');
...
define('_AM_SYSTEM_MODULES_NOTIFICATIONS_DELETE', 'Eliminazione notifiche...');
...
define('_AM_SYSTEM_MODULES_TABLE_DROPPED_FAILDED', 'ERRORE: Non permesso eliminare la tabella %s !');
// Tips
define('_AM_SYSTEM_MODULES_TIPS', '<ul>
<li>Se installi un nuovo modulo, ricorda di configurare le preferenze del modulo, i blocchi e i permessi degli utenti!</li>
<li>Per nascondere un modulo nel blocco del Menu Principale, imposta l\'ordine a 0</li>
<li>Elimina i file dei moduli inutilizzati dal tuo server per evitare problemi di sicurezza e mantenere il tuo sito sicuro.</li>
<li>Per cambiare l\'ordine dei moduli (che si rifletterà nel Menu), basta trascinare e rilasciare i moduli nella posizione desiderata.</li>
</ul>');
define('_AM_SYSTEM_MODULES_CONFIRM_TIPS', '<ul>
<li>Controlla tutte le modifiche per la validazione.</li>
</ul>');
// 2.5.7
define('_AM_SYSTEM_MODULES_INSTALL_TESTDATA', 'Aggiungi Dati di Test');
// 2.5.8
define('_AM_SYSTEM_MODULES_INSTALL_MORE', 'Installa altri moduli');
// 2.5.11
define('_AM_SYSTEM_MODULES_INSTALL_THISMODULE', 'Amministrazione di Questo Modulo');

// 2.7.0
define('_AM_SYSTEM_MODULES_FK_DISABLE', 'Impossibile disabilitare i controlli della chiave esterna');
define('_AM_SYSTEM_MODULES_FK_ENABLE', 'Impossibile abilitare i controlli della chiave esterna');
define('_AM_SYSTEM_MODULES_DROP_FAIL', 'Impossibile eliminare la tabella: %s');
define('_AM_SYSTEM_MODULES_DROP_OK', 'Tabella eliminata: %s');
